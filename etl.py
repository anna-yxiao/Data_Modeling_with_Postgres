...
def process_song_file(cur, filepath):
    ...
    :param filepath: complete filepath to load the file
    """
...
def process_data(cur, conn, filepath, func):
    ...
    :param filepath: parent filepath of files
...
def main():
    """
    Driver function to load songs and log data into the Postgres database.
    """
